...
?>
  ...
  <div class="cont1 n">
    ...
    <h1>Cash</h1>
    <a href="../clientAchat.php" onclick="local()" class="lien-ret"><svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none"><path d="M16 12H8M8 12L11 9M8 12L11 15" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M7 3.33782C8.47087 2.48697 10.1786 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 10.1786 2.48697 8.47087 3.33782 7" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/></svg></a>
    ...
    for ($i = 0; $i < count($_POST['nom_produit']); $i++) {
        ...
        if ($result_produit->num_rows > 0) {
            ...
            $insert_produits_commande = "INSERT INTO produits_commande (id_produit, id_commande, quantite, prix_unitaire, prix_total, Statut_transaction) 
                                         VALUES ($id_produit, $last_command_id, $quantite, $prix_unitaire, $prix_total, 'vendre')";
