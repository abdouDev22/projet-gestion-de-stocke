...
<head>
    ...
    <link rel="stylesheet" href="../../../asset/groupeR1.css">
...
if ($conn->connect_error) {
    ...
    $query_clients = "SELECT * FROM unitesvente" ;
        ...
        while ($row = $result_clients->fetch_assoc()) {
            ...
            <div class="item">
                <div class="item-content">
                    ...
                    <span><a href="sousservice/unite.php?id=<?php echo $row['id']; ?>" class="modifier">Traitement</a></span>
                </div>
            </div>
            <?php
        }
