...
if ($conn->connect_error) {
    ...
    $query_clients = "SELECT * FROM client_fourniseur  WHERE  `Type`='fournisseur'" ;
        ...
        while ($row = $result_clients->fetch_assoc()) {
            ...
            <div class="item">
                <div class="item-content">
                    ...
                    <span><a href="sousservice/entreprise.php?id=<?php echo $row['id']; ?>" class="modifier">Traitement</a></span>
                </div>
            </div>
            <?php
        }
