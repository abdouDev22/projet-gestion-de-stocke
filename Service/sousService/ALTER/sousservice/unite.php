...
<head>
    ...
    <link rel="stylesheet" href="../../../../asset/groupe.css">
...
if(isset($_GET['id'])){
  $_SESSION['Ater_unite']=$_GET['id'];
}
// ID de l'unité que vous souhaitez afficher
$idUnite = $_SESSION['Ater_unite'];

// Récupérer les informations de l'unité avec l'ID spécifié
$query = "SELECT * FROM unitesvente WHERE id = $idUnite";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $updateQuery = "UPDATE unitesvente SET nom = '$nouveauNom' WHERE id = $idUnite";

  if ($conn->query($updateQuery) === TRUE) {
    ?>
    <script>
        alert("information mise ajour");
        window.location.href ="../unite.php";
...
?>
    ...
    <div class="cont">
        <div class="titre">ALTER Unite</div>
        <a href="../unite.php" class="lien-ret"><svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none"><path d="M16 12H8M8 12L11 9M8 12L11 15" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M7 3.33782C8.47087 2.48697 10.1786 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 10.1786 2.48697 8.47087 3.33782 7" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/></svg></a>
        <form action="unite.php" method="post">
            <label for="" class="name">Name</label>
            <span class="name1"> <input type="text" name="nom" value="<?php echo $row['nom']  ?> "></span>
            <div class="chang"><button type="submit">ALTER</button></div>    
        </form>
      </div>
