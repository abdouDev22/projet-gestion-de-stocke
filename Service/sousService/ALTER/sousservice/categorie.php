...
<head>
    ...
    <link rel="stylesheet" href="../../../../asset/categorie.css">
...
if(isset($_GET['id'])){
  $_SESSION['Ater_categorise']=$_GET['id']; 
  $_SESSION['Ater_group']=$_GET['nom_groupe']; 
}

// ID de l'unité que vous souhaitez afficher
$idUnite =  $_SESSION['Ater_categorise'];
$group=$_SESSION['Ater_group'];
// Récupérer les informations de l'unité avec l'ID spécifié
$query = "SELECT * FROM categorie WHERE id = $idUnite";

$query_group_id = "SELECT * FROM groupes ";
...
if ($result->num_rows > 0) {
    ...
    ?>
    <script>
        alert("Aucune unité trouvée avec l'ID<?php $idUnite?>");
    </script>
    <?php
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $updateQuery = "UPDATE categorie SET nom = '$nouveauNom', id_Groupe = (SELECT id FROM groupes WHERE nom = '$nouveauGroupe') WHERE id = $idUnite";
...
?>
    ...
    <div class="cont">
        <div class="titre">ALTER Categorie</div>
        <a href="../categorie.php"  class="lien-ret"><svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none"><path d="M16 12H8M8 12L11 9M8 12L11 15" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M7 3.33782C8.47087 2.48697 10.1786 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 10.1786 2.48697 8.47087 3.33782 7" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/></svg></a>
        <form action="categorie.php" method="post">
            <label for="" class="name">Name</label>
            <span class="name1"> <input type="text" name="nom" value="<?php echo $row['nom']; ?>"></span>
            <label for="" class="groupe">Groupe</label>
            <span class="groupe1">
