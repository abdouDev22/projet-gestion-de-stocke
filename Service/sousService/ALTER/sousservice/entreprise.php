...
if(isset($_GET['id'])){
  $_SESSION['Ater_entreprise']=$_GET['id'];
}
// ID de l'unité que vous souhaitez afficher
$idUnite = $_SESSION['Ater_entreprise'];

// Récupérer les informations de l'unité avec l'ID spécifié
$query = "SELECT * FROM client_fourniseur WHERE id = $idUnite";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $updateQuery = "UPDATE client_fourniseur SET nom = '$nouveauNom', adresse='$adress',`telephone` ='$tel' WHERE id = $idUnite";
...
?>
    ...
    <div class="cont">
        <div class="titre">ALTER Entreprise </div>
        <a href="../entreprise.php" onclick="local()" class="lien-ret"><svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none"><path d="M16 12H8M8 12L11 9M8 12L11 15" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M7 3.33782C8.47087 2.48697 10.1786 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 10.1786 2.48697 8.47087 3.33782 7" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/></svg></a>
        <form action="entreprise.php" method="post">
            ...
            <span class="qua1"><input type="text" name="tel"  value="<?php echo $row['telephone']  ?> "></span>
            <label for="" class="pri">Adresse :</label>
            <span class="pri1"><input type="text" name="adress" value="<?php echo $row['adresse']  ?>"></span>
