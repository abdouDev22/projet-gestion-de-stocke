...
if ($conn->connect_error) {
    ...
    $query_clients = "SELECT * FROM Client_Fourniseur Where Type='client'" ;
        ...
        while ($row = $result_clients->fetch_assoc()) {
            ...
            <div class="item">
                <div class="item-content">
                    ...
                    <span class="fff"><input type="number" value="<?php echo $row['id']; ?>"></span>
                    <span><a href="sousservice/client.php?id=<?php echo $row['id']; ?>" class="modifier">Traitement</a></span>
                </div>
            </div>
            <?php
        }
