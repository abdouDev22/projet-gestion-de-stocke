...
<head>
    ...
    <link rel="stylesheet" href="../../../asset/clientR.css">
...
if ($conn->connect_error) {
    ...
    $utilisateur_connecte_id = $_SESSION['id_utilisateur'];
    $query_clients = "SELECT * FROM utilisateurs Where id != $utilisateur_connecte_id" ;
        ...
        while ($row = $result_clients->fetch_assoc()) {
            ...
            <div class="item">
                <div class="item-content">
                    <span class="no">Full Name</span>
                    <span class="no1"><?php echo $row['nomcomplet']; ?></span>
                    <span class="groupe">Telephone</span>
                    <span class="groupe1"><?php echo $row['telephone']; ?></span>
                    <span class="fff"><input type="number"></span>
                    <span><a href="sousservice/employe.php?id=<?php echo $row['id']; ?>" class="modifier">Traitement</a></span>
                </div>
            </div>
            <?php
        }
       ...
       filterButton1.addEventListener('keyup', function () {
        ...
        if (grid && titre) {
           ...
           for (var i = 0; i < items.length; i++) {
             ...
             let numElement = items[i].getElement().querySelector('.groupe1');
       
             if (titleElement || num) {
               let title = titleElement.textContent.toLowerCase(); 
               let num = numElement.textContent.toLowerCase();
