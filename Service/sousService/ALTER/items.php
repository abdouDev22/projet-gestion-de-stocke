...
<head> 
    ...
    <link rel="stylesheet" href="../../../asset/itemR2.css">
...
if ($conn->connect_error) {
    ...
    $query_clients = "SELECT produits.nom AS nom_produits, categorie.nom AS nom_categorie,quantite,prix, produits.id  AS id_produit
    FROM produits
      ...
      if ($result_clients->num_rows > 0) {
        while ($row = $result_clients->fetch_assoc()) {
            ?>
             ...
             <span class="no1"><?php echo $row['nom_produits']; ?></span>
             <span class="quantite">Quantité</span>
             <span class="quantite1"><?php echo $row['quantite']; ?></span>
             <span class="categorie">Categorie</span>
             <span class="categorie1"><?php echo $row['nom_categorie']; ?></span>
             <span class="prix">Prix</span>
             <span class="prix1"><?php echo $row['prix']; ?></span>
             <span class="fff"><input type="number"></span>
              <span><a href="sousservice/items.php ?id=<?php echo $row['id_produit']; ?>&& nom_cat=<?php echo $row['nom_categorie']; ?>" class="modifier">Traitement</a></span>
            </div>
            </div>
            <?php
        }
