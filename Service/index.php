...
?>
  ...
  <head>
    ...
    <link rel="stylesheet" href="../asset/Modifier.css">
  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <ul>
        ...
        <li class="list">
          <a href="sousService/profile/profile.php">
    ...
    <div class="cont">
      ...
      <a href="#" class="btn Alter">ALTER</a>
      <a href="#" class="btn Vendre">Vendre</a>
      <a href="sousService/REMBOURSER/Rembourser.php" class="btn remb">Rembourser</a>
      <a href="sousService/Vendre&Achat/entreprice.php" class="btn Acha">Achat</a>
      <a href="sousService/DayBock/Daybock.php" class="btn Day">Day bock</a>
    </div>
    <div class="cont1">
      ...
      <a href="sousService/Vendre&Achat/clientEmprunt.php" class="btn a">emprunter</a>
      <a href="sousService/Vendre&Achat/clientAchat.php" class="btn a1">Cash</a>
    </div>
    <div class="cont2">
      <a href="#" id="aa" class="lien-ret"><svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none"><path d="M16 12H8M8 12L11 9M8 12L11 15" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M7 3.33782C8.47087 2.48697 10.1786 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 10.1786 2.48697 8.47087 3.33782 7" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/></svg></a>
          <a href="sousService/ADD/items.php" class="btn Items">Items</a>
          <a href="sousService/ADD/categorie.php" class="btn Cathegorie">Cathegorie</a>
          <a href="sousService/ADD/unite.php" class="btn Unite">Unité</a>
          <a href="sousService/ADD/groupe.php" class="btn Groupe">Groupe</a>
          <a href="sousService/ADD/client.php" class="btn client">client</a>
          <a href="sousService/ADD/employe.php" class="btn employe">employe</a>
          <a href="sousService/ADD/entreprise.php" class="btn entreprise">Entrprise</a>
    </div>
  ...
  <script>
    const c=document.querySelector('.Vendre')
    c.addEventListener('click',function(){
      const f=document.querySelector('.cont')
      const d=document.querySelector('.cont1')
      d.classList.add('n')
      f.classList.add('f')
    })
    ...
    const kk=document.querySelector('.Add')
    kk.addEventListener('click',function(){
      const f=document.querySelector('.cont')
      const d=document.querySelector('.cont2')
      f.classList.add('f')
      d.style.left='05%'
      const items=document.querySelector('.Items').setAttribute('href', 'sousService/ADD/items.php')
      const Cathegorie=document.querySelector('.Cathegorie').setAttribute('href', 'sousService/ADD/categorie.php')
      const Unite=document.querySelector('.Unite').setAttribute('href', 'sousService/ADD/unite.php')
      const Groupe=document.querySelector('.Groupe').setAttribute('href', 'sousService/ADD/groupe.php')
      const client=document.querySelector('.client').setAttribute('href', 'sousService/ADD/client.php')
      const employe=document.querySelector('.employe').setAttribute('href', 'sousService/ADD/employe.php')
      const entreprise=document.querySelector('.entreprise').setAttribute('href', 'sousService/ADD/entreprise.php')
    })
    ...
    Alter.addEventListener('click',function(){
      ...
      f.classList.add('f')
      d.style.left='05%'
      const items=document.querySelector('.Items').setAttribute('href', 'sousService/ALTER/items.php')
      const Cathegorie=document.querySelector('.Cathegorie').setAttribute('href', 'sousService/ALTER/categorie.php')
      const Unite=document.querySelector('.Unite').setAttribute('href', 'sousService/ALTER/unite.php')
      const Groupe=document.querySelector('.Groupe').setAttribute('href', 'sousService/ALTER/groupe.php')
      const client=document.querySelector('.client').setAttribute('href', 'sousService/ALTER/client.php')
      const employe=document.querySelector('.employe').setAttribute('href', 'sousService/ALTER/employe.php')
      const entreprise=document.querySelector('.entreprise').setAttribute('href', 'sousService/ALTER/entreprise.php')
    })
    ...
    let ss=localStorage.getItem('nav-lien');
    
    if(ss==1){
      const nn=document.querySelector('.cont')
      const xx=document.querySelector('.cont2')
      nn.classList.add('f')
      xx.style.left='05%';
      const items=document.querySelector('.Items').setAttribute('href', 'sousService/ALTER/items.php')
      const Cathegorie=document.querySelector('.Cathegorie').setAttribute('href', 'sousService/ALTER/categorie.php')
      ...
      const nn=document.querySelector('.cont')
      const xx=document.querySelector('.cont1')
      nn.classList.add('f')
      xx.classList.add('n')
      localStorage.setItem('nav-lien', 0);
    }else if(ss==3){
    ...
    console.log(localStorage.getItem('nav-lien'))
  </script>
<script>
